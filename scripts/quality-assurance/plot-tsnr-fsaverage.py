...
fig.savefig('../../outputs/datapaper/tsnr/figures/group_inflated_median-tsnr-fsaverage.png',
            dpi=300)

fig = cortex.quickflat.make_figure(surface, with_rois=False, colorbar_location='right', height=2048)
fig.savefig('../../outputs/datapaper/tsnr/figures/group_flatmap_median-tsnr-fsaverage.png',
            dpi=300)
